<h2><a href="https://www.geeksforgeeks.org/problems/inverted-triangle-of-stars0110/1?page=1&category=pattern-printing&difficulty=Easy&status=unsolved&sortBy=submissions">Inverted triangle of stars</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an integer <strong>N</strong>, print an inverted isosceles triangle of stars such that the height of the triangle is <strong>N</strong>.</span></p>
