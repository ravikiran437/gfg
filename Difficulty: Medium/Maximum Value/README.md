<h2><a href="https://www.geeksforgeeks.org/problems/maximum-value--170645/1?page=4&category=Tree&difficulty=Medium&status=unsolved&sortBy=submissions">Maximum Value</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a binary tree, find the largest value in each level.</span></p>
